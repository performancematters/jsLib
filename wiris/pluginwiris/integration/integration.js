...
var _wrs_conf_createimagePath = _wrs_currentPath + '/core/functions/cf/formula/createimage.cfm';			// Specifies where is createimage script
...
var _wrs_conf_servicePath = _wrs_currentPath + '/core/tools/ckeditor/plugins/ckeditor_wiris/cfintegration/service.cfm';
...
// Vars
var _wrs_int_editorIcon = _wrs_currentPath +'/core/jsLib/wiris/pluginwiris/core/icons/formula.gif'; // '/pluginwiris/core/icons/formula.gif';
 ...
 */
function wrs_int_initxxxx(target) {
...
function PMI_Wiris_Init(target_element, target_iframe)
{
	...
	/* Assigning events to the WYSIWYG editor */
	wrs_addIframeEvents(PMI_Wiris_TargetIFrame, wrs_int_doubleClickHandler, wrs_int_mousedownHandler, wrs_int_mouseupHandler);
