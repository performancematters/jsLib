...
var _wrs_conf_editorPath = '/redwood/core/jsLib/wiris/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = '/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = '/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = _wrs_currentPath + '/pluginwiris/integration/editor.php';	// Editor window.
var _wrs_conf_editorAttributes = 'width=500, height=400, scroll=no, resizable=yes';		// Editor window attributes
var _wrs_conf_CASPath = '/redwood/core/jsLib/wiris/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = _wrs_currentPath + '/pluginwiris/integration/cas.php';			// CAS window.
var _wrs_conf_CASAttributes = 'width=640, height=480, scroll=no, resizable=yes';		// CAS window attributes.

var _wrs_conf_createimagePath = '/redwood/core/functions/cf/formula/createimage.cfm';        // _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = _wrs_currentPath + '/pluginwiris/integration/createimage.php';			// Script to create images.
var _wrs_conf_createcasimagePath = '/redwood/core/jsLib/wiris/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = _wrs_currentPath + '/pluginwiris/integration/createcasimage.php';	// Script to create CAS images.
...
// PMI Vars
//
var PMI_Wiris_PrimaryDocument = null;
...
{
	PMI_Wiris_OpenNewFormulaEditor(target_iframe, _wrs_int_language);
}

function PMI_Wiris_CASButtonClickedHandler(e)
{
	PMI_Wiris_OpenNewCAS(target_iframe, _wrs_int_language);
}

function PMI_Wiris_Init(target_textarea, target_iframe, primary_document)
{
	PMI_Wiris_TargetTextArea = target_textarea;
	PMI_Wiris_TargetIFrame = target_iframe;
	PMI_Wiris_PrimaryDocument = primary_document;
	...
	PMI_Wiris_TargetIFrame.contentWindow.document.body.innerHTML = wrs_initParse(textarea.value);

	/* Creating an event for parse the output text */
	var form = PMI_Wiris_TargetTextArea.form;
