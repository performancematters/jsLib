...
var _wrs_conf_editorPath       = CKEDITOR.basePath + 'plugins/ckeditor_wiris/cfintegration/editor.cfm';			// Specifies where is the editor HTML code (for popup window)
var _wrs_conf_editorAttributes = 'width=500, height=400, scroll=no, resizable=yes';								// Specifies formula editor window options
var _wrs_conf_CASPath          = CKEDITOR.basePath + 'plugins/ckeditor_wiris/cfintegration/cas.cfm';					// Specifies where is the WIRIS CAS HTML code (for popup window)
var _wrs_conf_CASAttributes    = 'width=640, height=480, scroll=no, resizable=yes';								// Specifies WIRIS CAS window options

var _wrs_conf_createimagePath    = CKEDITOR.basePath.match(/(.*\/core\/)/)[0]  + 'functions/cf/formula/createimage.cfm';			// Specifies where is createimage script
var _wrs_conf_createcasimagePath = CKEDITOR.basePath + 'plugins/ckeditor_wiris/cfintegration/createcasimage.cfm';	// Specifies where is createcasimage script
